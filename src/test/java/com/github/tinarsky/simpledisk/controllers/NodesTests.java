...
@SpringBootTest
@ContextConfiguration(initializers = {NodesTests.Initializer.class})
...
class NodesTests {
	...
	public void success() throws Exception {
		...
		var requestBuilder = get("/nodes/element3");

		mockMvc.perform(requestBuilder)
				.andDo(print())
				.andExpect(status().isOk())
				.andExpect(jsonPath("$.id", is("element3")))
				.andExpect(jsonPath("$.children[0].id", is("element2")))
				.andExpect(jsonPath("$.children[1]").doesNotExist())
				.andExpect(jsonPath("$.children[0].children[0].id", is("element1")))
				.andExpect(jsonPath("$.children[0].children[1]").doesNotExist())
				.andExpect(jsonPath("$.children[0].children[0].children").isEmpty());
	}
	...
	public void notFound() throws Exception {
		...
		var requestBuilder = get("/nodes/element0");
